...
# Dot-sourced by cli\Install-Extern.ps1 and Instellator\Install-Full.ps1 — not copied to psbin (see photontoaster\Install-PsBin.ps1 or shortps1\install.ps1).
#
